...
do_remedy_backup()
{
	...
	sudo mkdir -p "/home/$(config_get admin)/backup/remedy/jellyfin"
	sudo mkdir -p "/home/$(config_get admin)/backup/remedy/plex"
	sudo mkdir -p "/home/$(config_get admin)/backup/remedy/Radarr"
	sudo mkdir -p "/home/$(config_get admin)/backup/remedy/Sonarr"
	sudo mkdir -p "/home/$(config_get admin)/backup/remedy/Readarr"
	sudo mkdir -p "/home/$(config_get admin)/backup/remedy/Lidarr"
	sudo mkdir -p "/home/$(config_get admin)/backup/remedy/Prowlarr"
	sudo mkdir -p "/home/$(config_get admin)/backup/remedy/Bazarr"

	#sudo cp -r "/var/lib/plexmediaserver/Library/Application Support/Plex Media Server/Preferences.xml" "/home/$(config_get admin)/backup/remedy/plex"

	sudo cp -r "/opt/bazarr/data/config/config.ini" "/home/$(config_get admin)/backup/remedy/Bazarr"
	sudo cp -r "/opt/bazarr/data/db/bazarr.db" "/home/$(config_get admin)/backup/remedy/Bazarr"

	sudo cp -r "/var/lib/jellyfin/data/authentication.db" "/home/$(config_get admin)/backup/remedy/jellyfin"
	sudo cp -r "/var/lib/jellyfin/data/jellyfin.db" "/home/$(config_get admin)/backup/remedy/jellyfin"
	sudo cp -r "/var/lib/jellyfin/data/library.db" "/home/$(config_get admin)/backup/remedy/jellyfin"
	sudo cp -r "/var/lib/jellyfin/data/device.txt" "/home/$(config_get admin)/backup/remedy/jellyfin"

	sudo cp -r "/home/$(config_get admin)/.config/Radarr/radarr.db" "/home/$(config_get admin)/backup/remedy/Radarr"
	sudo cp -r "/home/$(config_get admin)/.config/Radarr/config.xml" "/home/$(config_get admin)/backup/remedy/Radarr"
	sudo cp -r "/home/$(config_get admin)/.config/Sonarr/sonarr.db" "/home/$(config_get admin)/backup/remedy/Sonarr"
	sudo cp -r "/home/$(config_get admin)/.config/Sonarr/config.xml" "/home/$(config_get admin)/backup/remedy/Sonarr"
	sudo cp -r "/home/$(config_get admin)/.config/Lidarr/lidarr.db" "/home/$(config_get admin)/backup/remedy/Lidarr"
	sudo cp -r "/home/$(config_get admin)/.config/Lidarr/config.xml" "/home/$(config_get admin)/backup/remedy/Lidarr"
	sudo cp -r "/home/$(config_get admin)/.config/Readarr/readarr.db" "/home/$(config_get admin)/backup/remedy/Readarr"
	sudo cp -r "/home/$(config_get admin)/.config/Readarr/config.xml" "/home/$(config_get admin)/backup/remedy/Readarr"
	sudo cp -r "/home/$(config_get admin)/.config/Prowlarr/prowlarr.db" "/home/$(config_get admin)/backup/remedy/Prowlarr"
	sudo cp -r "/home/$(config_get admin)/.config/Prowlarr/config.xml" "/home/$(config_get admin)/backup/remedy/Prowlarr"
}

do_remedy_restore()
{
	echo -e "${pharmacy_m} Restoring REMEDy config/db"
	#sudo cp -r "/home/$(config_get admin)/backup/remedy/plex/Preferences.xml" "/var/lib/plexmediaserver/Library/Application Support/Plex Media Server/Preferences.xml" 

	sudo cp -r "/home/$(config_get admin)/backup/remedy/Bazarr/config.ini" "/opt/bazarr/data/config/config.ini" 
	sudo cp -r "/home/$(config_get admin)/backup/remedy/Bazarr/bazarr.db" "/opt/bazarr/data/db/bazarr.db" 
	...
	sudo cp -r "/home/$(config_get admin)/backup/remedy/Radarr/radarr.db" "/home/$(config_get admin)/.config/Radarr/radarr.db"
	sudo cp -r "/home/$(config_get admin)/backup/remedy/Radarr/config.xml" "/home/$(config_get admin)/.config/Radarr/config.xml"
	sudo cp -r "/home/$(config_get admin)/backup/remedy/Sonarr/sonarr.db" "/home/$(config_get admin)/.config/Sonarr/sonarr.db"
	sudo cp -r "/home/$(config_get admin)/backup/remedy/Sonarr/config.xml" "/home/$(config_get admin)/.config/Sonarr/config.xml"
	sudo cp -r "/home/$(config_get admin)/backup/remedy/Lidarr/lidarr.db" "/home/$(config_get admin)/.config/Lidarr/lidarr.db"
	sudo cp -r "/home/$(config_get admin)/backup/remedy/Lidarr/config.xml" "/home/$(config_get admin)/.config/Lidarr/config.xml"
	sudo cp -r "/home/$(config_get admin)/backup/remedy/Readarr/readarr.db" "/home/$(config_get admin)/.config/Readarr/readarr.db"
	sudo cp -r "/home/$(config_get admin)/backup/remedy/Readarr/config.xml" "/home/$(config_get admin)/.config/Readarr/config.xml"
	sudo cp -r "/home/$(config_get admin)/backup/remedy/Prowlarr/prowlarr.db" "/home/$(config_get admin)/.config/Prowlarr/prowlarr.db"
	sudo cp -r "/home/$(config_get admin)/backup/remedy/Prowlarr/config.xml" "/home/$(config_get admin)/.config/Prowlarr/config.xml"
}
