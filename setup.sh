...
do_remedy_backup()
{
	...
	sudo -u "$(config_get admin)" mkdir -p "/home/$(config_get admin)/backup/remedy/jellyfin"
	sudo -u "$(config_get admin)" mkdir -p "/home/$(config_get admin)/backup/remedy/plex"
	sudo -u "$(config_get admin)" mkdir -p "/home/$(config_get admin)/backup/remedy/Radarr"
	sudo -u "$(config_get admin)" mkdir -p "/home/$(config_get admin)/backup/remedy/Sonarr"
	sudo -u "$(config_get admin)" mkdir -p "/home/$(config_get admin)/backup/remedy/Readarr"
	sudo -u "$(config_get admin)" mkdir -p "/home/$(config_get admin)/backup/remedy/Lidarr"
	sudo -u "$(config_get admin)" mkdir -p "/home/$(config_get admin)/backup/remedy/Prowlarr"
	sudo -u "$(config_get admin)" mkdir -p "/home/$(config_get admin)/backup/remedy/Bazarr"

	#sudo -u "$(config_get admin)" cp -r "/var/lib/plexmediaserver/Library/Application Support/Plex Media Server/Preferences.xml" "/home/$(config_get admin)/backup/remedy/plex"

	sudo -u "$(config_get admin)" cp -r "/opt/bazarr/data/config/config.ini" "/home/$(config_get admin)/backup/remedy/Bazarr"
	sudo -u "$(config_get admin)" cp -r "/opt/bazarr/data/db/bazarr.db" "/home/$(config_get admin)/backup/remedy/Bazarr"

	sudo -u "$(config_get admin)" cp -r "/var/lib/jellyfin/data/authentication.db" "/home/$(config_get admin)/backup/remedy/jellyfin"
	sudo -u "$(config_get admin)" cp -r "/var/lib/jellyfin/data/jellyfin.db" "/home/$(config_get admin)/backup/remedy/jellyfin"
	sudo -u "$(config_get admin)" cp -r "/var/lib/jellyfin/data/library.db" "/home/$(config_get admin)/backup/remedy/jellyfin"
	sudo -u "$(config_get admin)" cp -r "/var/lib/jellyfin/data/device.txt" "/home/$(config_get admin)/backup/remedy/jellyfin"

	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/.config/Radarr/radarr.db" "/home/$(config_get admin)/backup/remedy/Radarr"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/.config/Radarr/config.xml" "/home/$(config_get admin)/backup/remedy/Radarr"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/.config/Sonarr/sonarr.db" "/home/$(config_get admin)/backup/remedy/Sonarr"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/.config/Sonarr/config.xml" "/home/$(config_get admin)/backup/remedy/Sonarr"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/.config/Lidarr/lidarr.db" "/home/$(config_get admin)/backup/remedy/Lidarr"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/.config/Lidarr/config.xml" "/home/$(config_get admin)/backup/remedy/Lidarr"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/.config/Readarr/readarr.db" "/home/$(config_get admin)/backup/remedy/Readarr"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/.config/Readarr/config.xml" "/home/$(config_get admin)/backup/remedy/Readarr"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/.config/Prowlarr/prowlarr.db" "/home/$(config_get admin)/backup/remedy/Prowlarr"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/.config/Prowlarr/config.xml" "/home/$(config_get admin)/backup/remedy/Prowlarr"
}
...
do_remedy_restore()
{
	...
	#sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/backup/remedy/plex/Preferences.xml" "/var/lib/plexmediaserver/Library/Application Support/Plex Media Server/Preferences.xml" 

	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/backup/remedy/Bazarr/config.ini" "/opt/bazarr/data/config/config.ini" 
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/backup/remedy/Bazarr/bazarr.db" "/opt/bazarr/data/db/bazarr.db" 
	...
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/backup/remedy/Radarr/radarr.db" "/home/$(config_get admin)/.config/Radarr/radarr.db"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/backup/remedy/Radarr/config.xml" "/home/$(config_get admin)/.config/Radarr/config.xml"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/backup/remedy/Sonarr/sonarr.db" "/home/$(config_get admin)/.config/Sonarr/sonarr.db"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/backup/remedy/Sonarr/config.xml" "/home/$(config_get admin)/.config/Sonarr/config.xml"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/backup/remedy/Lidarr/lidarr.db" "/home/$(config_get admin)/.config/Lidarr/lidarr.db"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/backup/remedy/Lidarr/config.xml" "/home/$(config_get admin)/.config/Lidarr/config.xml"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/backup/remedy/Readarr/readarr.db" "/home/$(config_get admin)/.config/Readarr/readarr.db"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/backup/remedy/Readarr/config.xml" "/home/$(config_get admin)/.config/Readarr/config.xml"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/backup/remedy/Prowlarr/prowlarr.db" "/home/$(config_get admin)/.config/Prowlarr/prowlarr.db"
	sudo -u "$(config_get admin)" cp -r "/home/$(config_get admin)/backup/remedy/Prowlarr/config.xml" "/home/$(config_get admin)/.config/Prowlarr/config.xml"

	sudo chown $(config_get admin):$(config_get admin) /home/$(config_get admin)/.config/{Radarr,Sonarr,Lidarr,Readarr,Prowlarr} -R
}
